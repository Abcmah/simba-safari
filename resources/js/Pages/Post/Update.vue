...
import { Head, useForm, router } from '@inertiajs/vue3';
 let props =defineProps(['post','edit'])
//  console.log(props.edit)
 const form = useForm({
    title: props.post.title,
    blog: props.post.blog,
...
const submit = () => {
  if(props.edit){
    router.post(`/blog/${props.post.id}/update`,{
      _method:'patch',
      title:form.title,
      blog:form.blog,
      tags:form.tags,
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <div class="card">
            <div class="card-body">
              <h5 class="card-title">Update a Blog Post</h5>
              <form @submit.prevent="submit" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="col-12">
                  <div class="img">
                    <img :src="'/storage/'+props.post.image"/>
                  </div>
        ...
        <div class="col-lg-4">
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              ...
              <div id="budgetChart" style="" class="echart"></div>
          ...
          <div class="card">
            ...
            <div class="card-body pb-0">
              ...
              <div id="trafficChart" style="" class="echart"></div>
