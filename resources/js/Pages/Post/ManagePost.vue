...
const onDelete = (id)=>{
  router.delete(`/blog/${id}/delete`,{method:'delete'})
  console.log(id)
}
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr :key="post.id" v-for="post in posts.data">
                        <td><a :href="`/blog/${post.id}`" class="text-primary">{{ post.title }}</a></td>
                        <td><Link :href="`/blog/${post.id}/edit`" class=""><i class="bi bi-pen mx-1"></i>edit</Link></td>
                        <td><Button as="button" @click="onDelete(post.id)"><i class="bi bi-trash mx-1"></i>del</Button></td>
                      </tr>
                    </tbody>
                  </table>
                  <v-pagination
                    v-model="$page.props.posts.current_page"
                    :pages="$page.props.posts.last_page"
                    :range-size="2"
                    active-color="#DCEDFF"
